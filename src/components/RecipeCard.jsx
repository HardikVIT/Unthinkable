...
const RecipeCard = ({ recipeData }) => {
  ...
  return (
    <motion.div
      className="relative rounded-2xl p-6 mb-6 flex flex-col md:flex-row gap-6 border border-gray-100 overflow-hidden"
    ...
    >
      {/* --- Background Layer --- */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#EAF4E1]/70 via-[#F7FAF3]/80 to-[#DDEEDA]/60 rounded-2xl blur-sm opacity-90" />

      {/* --- Foreground Content --- */}
      <div className="relative flex flex-col md:flex-row gap-6 z-10">
        {/* --- Left Side: Text --- */}
        <div className="flex-1">
          <h2 className="text-2xl font-bold text-[#6A994E] mb-2">
            {recipe_name}
          </h2>
          ...
          <div>
            ...
            {reviewArray.map((r, idx) => (
              <div
                key={idx}
                className="p-2 rounded-lg mb-2 bg-[#6A994E]/10"
              >
